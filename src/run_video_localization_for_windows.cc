...
int main(int argc, char* argv[]) {
	...
	if (vocab_file_path == "" || video_file_path == "" || config_file_path == "" || map_db_path == "") {
	...
	if (cfg->camera_->setup_type_ == openvslam::camera::setup_type_t::Monocular) {
		mono_localization(cfg, vocab_file_path, video_file_path, mask_img_path,
			map_db_path, mapping, frame_skip, no_sleep, auto_term);
	}
	else {
